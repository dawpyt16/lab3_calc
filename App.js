...
export default class App extends React.Component {
    constructor() {
        ...
        onPress = (buttonValue: string) => {
            if(this.state.count == '0' || this.state.count == undefined && buttonValue == "."){
                this.setState({
                    count: buttonValue
                });
            }else if(this.state.count == '0' || this.state.count == undefined){
                this.setState({
                    count: buttonValue
                });
            }else{
                ...
                switch (buttonValue){
                    ...
                    case 'pi':
                        ...
                        this.setState({
                            ...
                            this.setState({
                            count: this.state.count * Math.PI
                            });
                        }
                        break;
                    case 'x^3':
